...
class MainWindow(QWidget):
    ...
    def _create_teacher_tab(self):
        ...
        self.tabs.addTab(self.teacher_tab, "Teachers") # добавляет в структуру с вкладками новую вкладку с названием "Table".
        self.teacher_gbox = QGroupBox("Teachers") # рамка, заголовок вверху и может отображать несколько виджетов внутри.
    ...
    def _create_subject_tab(self):
        ...
        self.tabs.addTab(self.subject_tab, "Subjects") # добавляет в структуру с вкладками новую вкладку с названием "Table".
        self.subject_gbox = QGroupBox("Subjects") # рамка, заголовок вверху и может отображать несколько виджетов внутри.
    ...
    def _add_day_from_monday(self, rowNum):
        self.cursor.execute("insert into timetable (day, subject_name) VALUES ('Monday', 'None')")
        self.conn.commit()
    #####################################################################################
    ...
    def _add_day_from_tuesday(self, rowNum):
        self.cursor.execute("insert into timetable (day, subject_name) VALUES ('Tuesday', 'None')")
        self.conn.commit()
    ...
    def _add_day_from_wednesday(self, rowNum):
        self.cursor.execute("insert into timetable (day, subject_name) VALUES ('Wednesday', 'None')")
        self.conn.commit()
    ...
    def _add_day_from_thursday(self, rowNum):
        self.cursor.execute("insert into timetable (day, subject_name) VALUES ('Thursday', 'None')")
        self.conn.commit()
    ...
    def _add_day_from_friday(self, rowNum):
        self.cursor.execute("insert into timetable (day, subject_name) VALUES ('Friday', 'None')")
        self.conn.commit()
    ...
    def _create_saturday_table(self):
        ...
        self.saturday_table.setHorizontalHeaderLabels(["Id", "Subject", "Room", "Time", "", ""])
    ...
    def _add_day_from_saturday(self, rowNum):
        self.cursor.execute("insert into timetable (day, subject_name) VALUES ('Saturday', 'None')")
        self.conn.commit()
